...
while inserir:
    salario = float(input(f'Digite o {len(salarios)+1}° salário: '))
    if salario != 0:
...
for salario in salarios:
    print(f'R${salario:>7} - R${abonos[salarios.index(salario)]:>7}')
...
print(f'Valor mínimo pago a {abonos.count(100.0)} colaboradores')
